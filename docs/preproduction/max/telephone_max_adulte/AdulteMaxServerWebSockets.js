...
var index = require("./routesAdu/index");
var app = express();

// view engine setup
app.set("views", path.join(__dirname, "viewsAdu"));
...
app.use(express.static(path.join(__dirname, "publicAdu")));
...
const wsServer = new WebSocket.Server({ port: 7474 });
